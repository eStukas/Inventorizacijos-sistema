...
Route::post('office_supplies', [OfficeSuppliesController::class, 'store'])->name('office_supplies.store');

/*Displaying specified office_supplies data */
Route::post('office_supplies/{id}', [OfficeSuppliesController::class, 'show'])->name('office_supplies.show');
...
Route::post('office_supplies/{id}', [OfficeSuppliesController::class, 'update'])->name('office_supplies.update');

/*Deleting office_supplies data */
Route::get('office_supplies/{id}', [OfficeSuppliesController::class, 'destroy'])->name('office_supplies.delete');
