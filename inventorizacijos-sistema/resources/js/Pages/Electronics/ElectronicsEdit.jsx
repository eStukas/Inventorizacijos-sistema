...
const ElectronicsEdit = ({ electronics, manufacturers, locations }) => {
    const { data, setData, put, processing, errors } = useForm({
        inv_code: electronics.inv_code || '',
        type: electronics.type || '',
        manufacturer_id: electronics.manufacturer_id || '',
        status: electronics.status || '',
        location_id: electronics.location_id || '',
        manufacture_date: electronics.manufacture_date || '',
        acquisition_date: electronics.acquisition_date || '',
    });

    const handleSubmit = (e) => {
        e.preventDefault();
        put(route('electronics.update', electronics.id));
    };
    ...
    return (
        <AuthenticatedLayout>
            ...
            <div className="container mx-auto px-4">
                <Head title="Edit Electronics" />

                <h1 className="text-3xl font-bold mb-4">Edit Electronics</h1>
                ...
                <form onSubmit={handleSubmit} className="bg-white p-6 rounded-md shadow-md">
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                        />
                        {errors.manufacture_date && <p className="text-red-600 text-sm mt-1">{errors.manufacture_date}</p>}
                    </div>
...
export default ElectronicsEdit;