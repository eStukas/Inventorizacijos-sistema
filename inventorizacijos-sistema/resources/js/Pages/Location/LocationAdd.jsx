                ...
                <form onSubmit={handleSubmit} className="bg-white shadow-md rounded-md p-6 space-y-4">
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            className={`mt-1 block w-full rounded border ${errors.type ? 'border-red-500' : 'border-gray-300'
                                } shadow-sm focus:ring-blue-500 focus:border-blue-500`}
                            required
                        />
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            className={`mt-1 block w-full rounded border ${errors.user_id ? 'border-red-500' : 'border-gray-300'
                                } shadow-sm focus:ring-blue-500 focus:border-blue-500`}
                        />
